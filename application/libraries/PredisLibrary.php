 ...
 class PredisLibrary{
        ...
        */
        public function getMemberOfMultipleString($keysArray){
            ...
            return $this->client->mget($keysArray);
        }
        ...
        public function moveMemberBetweenSets($key, $destinationKey, $member){
        	...
        	Contract::mustBeNonEmptyVariable($destinationKey, 'Set Destination Key');
        	Contract::mustBeNonEmptyVariable($member, 'Set Member');
        ...
        public function getMembersInSortedSet($key,$start,$stop,$reverseOrder = FALSE, $withScore = TRUE){
